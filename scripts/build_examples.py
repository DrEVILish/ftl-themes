...
def stats(*items):
    return toolbar(*[stat(*i) for i in items])
...
def _():
    return page(
        ...
        [
            ...
            panel("Radio",
                  segmented(["Diamond City Radio", "Classical Radio", "Distress Signal"], label="Station"),
